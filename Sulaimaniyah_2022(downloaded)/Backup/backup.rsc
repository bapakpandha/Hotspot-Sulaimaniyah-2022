# jul/25/2022 16:39:01 by RouterOS 6.48.5
...
add dns-name=wifisulaimaniyah.net hotspot-address=10.20.30.1 html-directory=\
    Sulaimaniyah_2022/hotspot login-by=http-chap,http-pap,trial,mac-cookie \
    name=Hotspot_Sulaimaniyah trial-uptime-limit=15m
/ip pool
...
add address=10.20.30.49 mac-address=00:05:FE:56:00:66 server=\
    Hotspot_Sulaimaniyah to-address=10.20.30.10 type=bypassed
/ip hotspot user
set [ find default=yes ] limit-bytes-out=300000000
add name=sulaimaniyah password=sulaimaniyah
add limit-bytes-out=5000000000 name=Abi1 password=Abi1 profile=Abiler
add limit-bytes-out=5000000000 name=Abi2 password=Abi2 profile=Abiler
add limit-bytes-out=5000000000 name=Abi3 password=Abi3 profile=Abiler
add limit-bytes-out=5000000000 name=Abi4 password=Abi4 profile=Abiler
add limit-bytes-out=5000000000 name=Abi5 password=Abi5 profile=Abiler
add limit-bytes-out=5000000000 name=Abi6 password=Abi6 profile=Abiler
add limit-bytes-out=5000000000 name=Abi7 password=Abi7 profile=Abiler
add limit-bytes-out=5000000000 name=Abi8 password=Abi8 profile=Abiler
add limit-bytes-out=5000000000 name=Abi9 password=Abi9 profile=Abiler
add limit-bytes-out=5000000000 name=Abi10 password=Abi10 profile=Abiler
add comment=baru limit-bytes-out=2000000000 name=aditya password=23456 \
    profile=Talebeler
add comment=baru limit-bytes-out=2000000000 name=syafiq password=7777 \
    profile=Talebeler
add comment=baru limit-bytes-out=2000000000 name=akhsan password=2222 \
    profile=Talebeler
add comment=baru limit-bytes-out=2000000000 name=maulana password=45678 \
    profile=Talebeler
add comment=baru limit-bytes-out=2000000000 name=raffy password=abcd profile=\
    Talebeler
add comment=baru limit-bytes-out=2000000000 name=muflih password=3456 \
    profile=Talebeler
add comment=baru limit-bytes-out=2000000000 name=alif password=4321 profile=\
    Talebeler
add comment=baru limit-bytes-out=2000000000 name=padli password=qwerty \
    profile=Talebeler
add comment=baru limit-bytes-out=2000000000 name=dava password=terserah \
    profile=Talebeler
add comment=baru limit-bytes-out=2000000000 name=zulfan password=4444 \
    profile=Talebeler
add comment=baru limit-bytes-out=2000000000 name=mamay password=6543 profile=\
    Talebeler
add comment=baru limit-bytes-out=2000000000 name=ghozi password=0123 profile=\
    Talebeler
add comment=baru limit-bytes-out=2000000000 name=lahfiz password=indonesia \
    profile=Talebeler
add comment=baru limit-bytes-out=2000000000 name=farhan password=password \
    profile=Talebeler
add comment=baru limit-bytes-out=2000000000 name=surya password=5678 profile=\
    Talebeler
add comment=baru limit-bytes-out=2000000000 name=yusuf password=5432 profile=\
    Talebeler
add comment=baru limit-bytes-out=2000000000 name=rehan password=9999 profile=\
    Talebeler
add comment=baru limit-bytes-out=2000000000 name=nafis password=0000 profile=\
    Talebeler
add comment=baru limit-bytes-out=2000000000 name=niam password=tekamul \
    profile=Talebeler
add comment=baru limit-bytes-out=2000000000 name=doni password=12345 profile=\
    Talebeler
add comment=baru limit-bytes-out=2000000000 name=daizona password=56789 \
    profile=Talebeler
add comment=baru limit-bytes-out=2000000000 name=firdaus password=3333 \
    profile=Talebeler
add comment=baru limit-bytes-out=2000000000 name=kresna password=2345 \
    profile=Talebeler
add comment=baru limit-bytes-out=2000000000 name=yaska password=1234 profile=\
    Talebeler
add comment=baru limit-bytes-out=2000000000 name=fadhil password=abcde \
    profile=Talebeler
add comment=baru limit-bytes-out=2000000000 name=arif password=5555 profile=\
    Talebeler
add comment=baru limit-bytes-out=2000000000 name=mahdi password=9876 profile=\
    Talebeler
add comment=baru limit-bytes-out=2000000000 name=abdul password=uicci \
    profile=Talebeler
add comment=baru limit-bytes-out=2000000000 name=zaenal password=8888 \
    profile=Talebeler
add comment=baru limit-bytes-out=2000000000 name=yahya password=6789 profile=\
    Talebeler
add comment=baru limit-bytes-out=2000000000 name=talebe31 password=bebas \
    profile=Talebeler
add comment=baru limit-bytes-out=2000000000 name=talebe32 password=4567 \
    profile=Talebeler
add comment=baru limit-bytes-out=2000000000 name=talebe33 password=\
    sulaimaniyah profile=Talebeler
add comment=baru limit-bytes-out=2000000000 name=talebe34 password=turki \
    profile=Talebeler
add comment=baru limit-bytes-out=2000000000 name=talebe35 password=7654 \
    profile=Talebeler
add comment=baru limit-bytes-out=2000000000 name=talebe36 password=1111 \
    profile=Talebeler
add comment=baru limit-bytes-out=2000000000 name=talebe37 password=8765 \
    profile=Talebeler
add comment=baru limit-bytes-out=2000000000 name=talebe38 password=yogyakarta \
    profile=Talebeler
add comment=baru limit-bytes-out=2000000000 name=talebe39 password=6666 \
    profile=Talebeler
add comment=baru limit-bytes-out=2000000000 name=talebe40 password=sleman \
    profile=Talebeler
/ppp profile
...
add name=Test password=Test profile=Abiler_maks_2MB remote-address=\
    192.168.10.107 service=pppoe
/system clock
...
/system ntp client
set enabled=yes primary-ntp=103.123.108.224 secondary-ntp=216.40.34.37
/system routerboard settings
set auto-upgrade=yes
/system scheduler
add interval=1d name=enable_talebe_jam_530 on-event=Enable_Talebeler policy=\
    ftp,reboot,read,write,policy,test,password,sniff,sensitive,romon \
    start-date=jul/17/2022 start-time=02:02:00
add interval=1d name=disable_talebeler_jam23 on-event=Disable_Talebeler \
    policy=ftp,reboot,read,write,policy,test,password,sniff,sensitive,romon \
    start-date=jul/17/2022 start-time=02:00:00
add interval=1d name=reset_counter_Abi on-event=Reset_Counter_Abi policy=\
    ftp,reboot,read,write,policy,test,password,sniff,sensitive,romon \
    start-date=jul/24/2022 start-time=00:00:00
/system script
...
add dont-require-permissions=no name=Reset_Counter_Abi owner=sulaimaniyah2007 \
    policy=ftp,reboot,read,write,policy,test,password,sniff,sensitive,romon \
    source=":local profil \"Abiler\";:local kata \"spesial\";:local daftar [/i\
    p hotspot user find profile=\$profil];:foreach usr in=\$daftar do={:local \
    nama [/ip hotspot user get \"\$usr\" name];:put \$nama;/ip hotspot user re\
    set-counters \$nama;/ip hotspot user set \$nama limit-bytes-out=5G}"
